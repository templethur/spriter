...
public class Animation {
	...
	protected void tweenBone(Bone bone1, Bone bone2, Bone target, float t, SpriterCurve curve){
	...
	public void prepare(){
		...
		for(int i = 0; i < this.tweenedKeys.length; i++){
			...
			this.tweenedKeys[i].setObject(new Timeline.Key.Object(new SpriterPoint(0,0)));
			this.mappedTweenedKeys[i].setObject(new Timeline.Key.Object(new SpriterPoint(0,0)));
		}
		this.prepared = true;
	}
