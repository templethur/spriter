...
public class Entity {
    ...
    public static class ObjectInfo{
    	...
    	public ObjectInfo(String name, ObjectType type, SpriterDimension size, List<FileReference> frames){
    		this.type = type;
    		this.frames = frames;
    		this.name = name;
    		this.size = size;
